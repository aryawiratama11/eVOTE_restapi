...
--
-- Host: localhost
-- Generation Time: Jun 16, 2016 at 01:00 පෙ.ව.
...
(2, 987612456, 'Dulitha Dabare', '12345bjhb', '$2y$10$skIF/brHR5noVdbnYkaS1.HUzgdrlzIytWWwiqFtdBeXmGPiAcEA2'),
(3, 708965213, 'Udara Bibile', '12345', '$2y$10$U2PQcF8ZYSdI244WDJ8H2e2rzu4zLpg6uVZWfdqwb/kKPcKC8m.OK'),
(4, 765563908, 'Sithira Weeratunga', '12345', '$2y$10$IzdycBb9rGfIRUW5CE75IunRidlEo94ezMmrXeSRkxZGSj5LaO8ey'),
(6, 987623156, 'Kamal Perera', '12345', NULL),
(7, 786533421, 'sasanka nandasiri', '$2y$10$MISwUuPY2jcSfIUYBMPrie3Sz6bb0khw2/KkIkbqBIwCr8KNaS9fG', NULL),
...
(1, 1, 1, 1, '2016-06-15 10:00:31'),
(3, 2, 1, 1, '2016-05-24 00:00:00'),
(8, 9, 1, 2, '2016-06-15 21:15:36'),
(9, 9, 2, 10, '2016-06-15 22:59:22');
...
--
ALTER TABLE `choices`
  MODIFY `choice_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `votes`
  MODIFY `v_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
